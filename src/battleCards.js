...
export const CHARACTER_DECKS = {
  ...
  darkHofuku: {
    composition: {
      ...
      items: [
        ...
        { def: ITEM_CATALOG.twinHammer, count: 1 },
        { def: ITEM_CATALOG.shinkenShirahadori, count: 1 },
        { def: ITEM_CATALOG.stegoro, count: 1 },
        { def: ITEM_CATALOG.harinezumiNoFuku, count: 1 },
        { def: ITEM_CATALOG.zangokuKen, count: 1 },
      ],
      spells: [
  ...
  darkShoujoA: {
    composition: {
      monsters: [
        ...
        { def: MONSTER_CATALOG.aruKagakuNo, count: 3 },
  ...
  thirty: {
    composition: {
      monsters: [
        { def: MONSTER_CATALOG.ninja, count: 3 },
        { def: MONSTER_CATALOG.mysteriousInvader, count: 2 },
        { def: MONSTER_CATALOG.battleTrain, count: 2 },
        { def: MONSTER_CATALOG.sacrificeCar, count: 2 },
        { def: MONSTER_CATALOG.kodaiNoGearA, count: 2 },
        { def: MONSTER_CATALOG.kodaiNoGearB, count: 2 },
        { def: MONSTER_CATALOG.kodaiNoGearC, count: 2 },
        { def: MONSTER_CATALOG.gandamu, count: 2 },
        { def: MONSTER_CATALOG.raiheishinZamurai, count: 1 },
