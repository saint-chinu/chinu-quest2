...
export const CHARACTER_DECKS = {
   ...
   * 2枚は引き込みと再配置用。侵略はチヌに任せ、雷神の盾で雷の主力を守る。
   */
  queFinal: {
    composition: {
      monsters: [
      ...
      items: [
        { def: ITEM_CATALOG.raijinNoTate, count: 4 },
        { def: ITEM_CATALOG.lifeJacket, count: 2 },
      ],
      spells: [
        { def: SPELL_CATALOG.iCanFly, count: 3 },
   ...
   * お札ありの長期戦、**合体系（ガシャーン）だけ禁止で他のEXは可**、属性は自由。
   *
   ...
   * 固定40枚（モンスター21／アイテム12／スペル7）。専用札は言論封殺1・怨念の集合体2。
   */
  chinu: {
    composition: {
