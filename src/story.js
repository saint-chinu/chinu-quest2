...
export const STORY_STAGES = [
  ...
  },
  {
    ...
    intro: [
      ...
      { speaker: 'クエ', text: 'ワイはハタ類の王、クエや。王には金庫番が要る。この海の金の流れは、ぜんぶワイが握っとる。' },
      { speaker: 'クエ', text: 'マダイの旦那は「王は二人も要らん」で牢屋行きやったけどな。ワイは王と張り合わへん。王の後ろで儲けるんが、いちばん賢い。' },
      { speaker: 'チヌ', text: '二対一だ。文句はあるまい。下賤の者が王の間まで来た褒美に、絶望を存分に味わわせてやろう。' },
