...
export const STORY_STAGES = [
  ...
  },
  {
    ...
    outro: [
      ...
      { speaker: '少女A', text: '次に会う時までに払っておくゆ。延滞すると、また特命調査に行くゆ。' },
    ...
    replay: {
      intro: [
        ...
        { speaker: '少女A', text: '未納が残っている限り、何度でも調査するゆ。' },
