...
export const STORY_STAGES = [
  ...
  },
  {
    ...
    intro: [
      ...
      { speaker: '???', text: 'お札の値段を決めるのは盤面そのもの。その属性の土地が増え、レベルが上がるほど値上がりする。開始時はどれも1枚10G、上限は100Gだ。' },
      { speaker: '???', text: '売買でも相場は動く。200Gぶん買えば1G上がり、同じだけ売れば1G下がる。買い占めて自分で高値を作ることもできる。' },
      { speaker: '???', text: '取引できるのはゴールを通過したとき。チェックポイントが揃っていなくても相場は開く。持っているお札は時価で総資産に加算され、周回ボーナスにも評価額の5%が上乗せされる。' },
