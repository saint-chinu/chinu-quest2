...
export const STORY_STAGES = [
  ...
  },
  {
    ...
    title: '⑬ 最終決算',
    format: '2vs2',
    // 同盟合算の目標。長丁場ほど監査側の複利（通行料網・お札の含み益・
    ...
    ally: {
      ...
      // 味方クエは「相場で支える参謀」に徹し、盤面の攻めはプレイヤーの仕事に
      // する（クエが従来の好戦性のままだと、プレイヤーが何もしなくても
      // クエ単独で監査側を殴り倒してしまい、工夫が要らないステージになる）。
      aiProfile: {
        minWinProbabilityToInvade: 0.8,
        itemGambleChance: 0.2,
        highValueAvoidance: 0.7,
      },
    },
    intro: [
      { speaker: '???', text: 'クエとの決着から数日。金融街の空気が、妙に静かだった。' },
      { speaker: 'クエ', text: 'おい魚ァ！！ 大変や！！ 街に税務調査が入った！！ 全部や、全部差し押さえる言うとる！！' },
      { speaker: '主人公', text: 'また税金か！ この海、税務署強すぎるだろ！' },
      { speaker: 'ムール', text: 'お久しぶりです。海上金融街の総合調査を開始します。申告漏れの疑いは……この街全体です。' },
      { speaker: '専門調査官・A', text: '沈没都市の帳簿から泳がせてたゆ。行き着く先がこの街だったというだけゆ。' },
      { speaker: 'クエ', text: 'ワイの街をまるごと監査やと！？ 魚ァ、手ェ組むで。ワイの相場とお前の腕なら勝ち目はある！' },
      { speaker: '主人公', text: 'この前まで処刑する言ってた奴と同盟か……。まあいい、乗った！' },
      { speaker: 'ムール', text: '私は本部決算担当。動きません。関所を築き、帳簿を積み、確定した資産だけで勝ちます。' },
      { speaker: '専門調査官・A', text: 'こっちは機動調査班ゆ。街を回って回って、お札を買い占めて、盤面ごと雷色に塗り替えるゆ。' },
      { speaker: 'クエ', text: 'ええか魚、あいつらは殴っても勝てんぞ。守りの本体は聖域と呪い、攻めの本体は相場や。' },
      { speaker: 'クエ', text: '固めた関所は塗り替えるか呪いを剥がして崩す。買い占め屋には、逆にあいつの属性を高値で売りつけたれ。' },
      { speaker: 'クエ', text: 'ワイは相場と土地で銭を作る。盤面の斬った張ったは、お前が仕切れ。' },
      { speaker: '主人公', text: 'モンスターの強さだけじゃ届かない相手ってわけか……。数字で勝つぞ！' },
      { speaker: '???', text: '金色同盟と監査同盟、金融街の頂上決算が始まった。目標は同盟合わせて総資産20,000G！' },
    ],
    outro: [
      { speaker: 'ムール', text: '……決算を終了します。この街の帳簿に、重大な不正は確認できませんでした。' },
      { speaker: '専門調査官・A', text: '完敗ゆ。相場で調査官に勝つ魚がいるとは思わなかったゆ。' },
      { speaker: 'クエ', text: 'ハッハァ！ 見たか！ ワイの街はワイと魚が守ったんや！' },
      { speaker: 'ムール', text: 'ただし、クエ。あなた個人の申告には7件の疑義があります。後日、改めて伺います。' },
      { speaker: 'クエ', text: 'は！？ ちょ、待て、それは話が違……' },
      { speaker: '主人公', text: 'そこは自力で何とかしろよ、フィクサーだろ。' },
      { speaker: '???', text: '監査は終わり、相場はまた動き出す。主人公は数字の海を泳ぎ切った。' },
    ],
    opponents: [
      {
        name: 'ムール',
        ...
        // 国費の調査予算。序盤から関所網と相場仕込みを同時に走らせるための
        // ボス補正（ラスボス級ステージなので、力押しの主人公より早く
        // 経済エンジンが立ち上がることを保証する）。
        startingCurrency: 900,
        // ⑨のムールより籠城へ振り切る: 確実に勝てる時しか動かず、育った
        // 土地には触れない。戦いの本体はデッキ側の聖域・アリジゴク・相場。
        aiProfile: {
          minWinProbabilityToInvade: 0.75,
          itemGambleChance: 0.15,
          highValueAvoidance: 0.75,
      ...
      },
      {
        name: '専門調査官・A',
        color: 0xf4b942,
        deckKey: 'investigatorKessan',
        theme: { elements: [Element.THUNDER] },
        startingCurrency: 1200,
        // 周回・相場特化: 戦闘はほぼ放棄（侵略しきい値0.85）。fixer型の
        // お札運用と帰巣本能の自己使用（lapRacer）で資産を積む。
        aiProfile: {
    ...
    replay: {
      intro: [
        { speaker: 'ムール', text: '定期監査の時間です。前回の決算には、まだ確認したい数字が残っています。' },
        { speaker: '専門調査官・A', text: '今回は目標24,000Gゆ。長期戦は相場側が有利ゆ。覚悟するゆ。' },
        { speaker: 'クエ', text: '望むところや。魚、今回も組むで！' },
      ],
      outro: [
        { speaker: 'ムール', text: '……再監査、終了。あなたたちの帳簿は、認めるほかありません。' },
        { speaker: '専門調査官・A', text: 'また数字が動いたら来るゆ。それが調査官の仕事ゆ。' },
      ],
      // 長期戦ほど相場と周回が効く監査側有利の条件で、再戦を本気の決算戦にする。
      goalCurrency: 24000,
    },
  },
];
