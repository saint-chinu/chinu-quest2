...
export const STORY_STAGES = [
  ...
  },
  {
    ...
    intro: [
      ...
      { speaker: 'ニュウドウカジカ（お肉）', text: 'そのケンカ、俺も混ぜてもらうぞ！' },
      { speaker: '暴君マダイ', text: 'お肉……てめえ、俺に逆らうつもりか？' },
      { speaker: 'ニュウドウカジカ（お肉）', text: 'ずっとお前に虐げられてきたんだ。反撃のチャンスを待っていた。今日こそ好きにはさせねえ！' },
    ...
    outro: [
      ...
      { speaker: 'ニュウドウカジカ（お肉）', text: 'おいおい、二人だけで話をまとめるなよ。俺だってずっとマダイに立ち向かいたかったんだ。' },
      { speaker: '暴君マダイ', text: '……悪かったな、お肉。力で押さえつければ誰も逆らわないと思っていた。だが、お前にも意地があったんだな。' },
      { speaker: 'ニュウドウカジカ（お肉）', text: 'わかればいいんだ。これからは暴君じゃなく、北の海の仲間としてやっていこうぜ。' },
      { speaker: '暴君マダイ', text: 'ふん、仕方ねえ。お肉、この海を一緒に守るぞ。今度は俺の隣でな。' },
      { speaker: 'ニュウドウカジカ（お肉）', text: 'へへっ、そうこなくちゃな！' },
