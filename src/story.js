...
export const STORY_STAGES = [
  ...
  },
  {
    ...
    intro: [
      ...
      { speaker: '主人公', text: 'いやいや、ぶつかっただけで1億円は無理があるだろ。しかも相場操作って言ったよな？' },
      ...
      { speaker: '???', text: 'このステージでは「お札」の売買が解禁される。ゴールで相場を見て、土地とお札の両方で総資産15,000Gを目指せ！' },
      { speaker: '???', text: 'なお、ここはサドンデス。破産した時点で敗北が確定する。' },
    ],
    outro: [
