...
export const STORY_STAGES = [
  ...
  },
  {
    ...
    // 初めて直接対決する。**主人公 vs チヌの1vs1、両者500Gの対等スタート**
    // （ユーザー指定「普通に対等の条件でスタートしないとゲームとしておかしい」。
    // チヌ側の初期資金補正は入れない）。
    format: '1vs1',
    // 長期戦想定（ユーザー指定）。18,000でも22,000でも敵側勝率は約40%（各100戦）で
    // 変わらないため、より長い22,000を採用。詳細はCLAUDE.md「⑱の数値調整」。
    goalCurrency: 22000,
    // 両者1,000Gスタート（ユーザー指定「1000スタートでよくね？」）。**主人公も
    // チヌも同額**。opponent側には置かない（片側だけの補正はしない）。
    startingCurrency: 1000,
    // 会話は全文ユーザー指定（2026-09）。「主人公」は丸括弧を付けずそのまま書く
    // （withHeroName(main.js)が表示直前にプレイヤーのキャラ名へ置換する）。
    intro: [
      { speaker: '主人公', text: 'はぁ、はぁ、はぁ。追手をくぐりぬけてやっとたどりついた...チヌの野郎、こんどこそ！！' },
      { speaker: 'チヌ', text: 'フン、脱走したのはお前か。小癪な真似を。' },
      { speaker: '主人公', text: 'すべての魚たちの自由を取り戻しに来たぞ。これ以上、お前の好きにはさせない！！' },
      { speaker: 'チヌ', text: 'いいだろう、力の差に絶望するがいい。二度と歯向かわないよう躾が必要だな。' },
      { speaker: 'チヌ', text: '『生まれの差』というものを知るがいい。貴様のような下賤の者は、いくら努力しようと無駄なのだ。' },
      { speaker: '主人公', text: 'この海には無限の可能性があるんだ、おまえこそ思い知れ！！' },
    ],
    // 勝利後。チヌが「真の姿」を予告して終わり、そのまま⑲（同じ盤面でチヌ＆クエ）へ。
    outro: [
      { speaker: '主人公', text: 'やった...ついにチヌを倒したぞ！！' },
      { speaker: 'チヌ', text: 'ククク、雑魚にしては中々やるではないか。少々見くびっていたようだ。' },
      { speaker: '主人公', text: 'どういうことだ！？' },
      { speaker: 'チヌ', text: '...お前には、真の恐怖を教えてやる必要があるな。ワイの真の姿をお見せしよう' },
      { speaker: '主人公', text: '！？！？' },
    ],
    overlaySpeakerSides: {
      主人公: 'right',
  ...
  },
  {
    ...
    // 結末の後にエンディングロール（main.jsのplayEndingRoll: 各ステージの背景と
    // 立ち絵が浮かんで消えていく＋クレジット）。真エンド・バッドエンドどちらでも流す。
    endingRoll: true,
    // 会話（2026-09）。結末の芯（「屍の上」「ChinuQueST...」「怨念の連鎖は...」）は
    // ユーザー指定の確定稿で、その前後を補完してある（ユーザー指定「ラストバトルで
    // これは短い」）。「主人公」は丸括弧無しで書く（withHeroNameが置換する）。
    intro: [
      { speaker: '???', text: '王の間。倒れたはずのチヌの周りに、無数の骨が集まってくる。殺された魚たちの骨が、蠢きながらひとつの塊になっていく。' },
      { speaker: '主人公', text: 'な、なんだよこれ……骨が、動いてる……！？' },
      { speaker: 'チヌ', text: 'これがワイの真の姿だ。ワイに逆らい、施設で果てた魚ども。その怨念を束ねたものが、ワイの力の源よ。' },
      { speaker: 'チヌ', text: '貴様が壊した労働施設も、その燃料を集めるための装置に過ぎん。壊したところで、もう十分に溜まっている。' },
      { speaker: '主人公', text: 'ふざけるな……！みんなを、そんなもののために……！' },
      { speaker: 'クエ', text: 'まあまあ、熱くならんといてや。' },
      { speaker: '主人公', text: 'クエ！？お前、なんでここに……' },
      // ⚠️ 設定（ユーザー指定 2026-09）: **クエはチヌの「表の姿」が表面化したもの**。
      // 金融街のフィクサーとしての顔が表、怨念の塊が裏。チヌとクエは元から一人。
      // クレジットの「企画・クエ（チヌ）」もこの設定。
      { speaker: 'チヌ', text: '気づかんのか。海上金融街で貴様の前に立ったフィクサー。あれはワイの表の姿が表面化したものよ。' },
      { speaker: 'クエ', text: 'ワイはハタ類の王、クエ。せやけど中身はこの通りや。表で相場を握り、裏で怨念を束ねる。王は二人も要らん――最初から一人やからな。' },
      { speaker: '主人公', text: '表の顔が既にフィクサーかよ！！' },
      { speaker: 'チヌ', text: '二対一……いや、ワイ一人と言うべきか。文句はあるまい。下賤の者が王の間まで来た褒美に、絶望を存分に味わわせてやろう。' },
      { speaker: '主人公', text: '……上等だ。ここで終わらせる。骨になった魚たちの分まで、全部まとめて背負ってやる！' },
    ],
    // 真エンド（サーティーの助け無し）。「屍の上」の一言（この時点でEX「怨念の集合体」を
    // 入手）→タイトル回収のメタ小咄で締める（ユーザー指定「小話が最後」）。
    // ⚠️ 主人公の「急に」はユーザー原文「旧に」を変換ミスと見て直したもの。
    outro: [
      { speaker: '???', text: '骨の塊が崩れ、王の間に静けさが戻る。チヌは玉座にもたれたまま、動かない。' },
      { speaker: '主人公', text: 'はぁ……はぁ……。終わった、のか……？' },
      { speaker: 'クエ', text: '……まいった。ワイの相場も、ここまでやな。あんた、ほんまに一人でここまで来よったんか。' },
      { speaker: 'チヌ', text: '……見事だ。誰の手も借りず、ワイの前に立った者は貴様が初めてよ。' },
      { speaker: 'チヌ', text: 'ならば、これを持っていけ。ワイの力の源。貴様に付き従った魚たちの怨念だ。' },
      { speaker: 'チヌ', text: 'お前がたどり着いた場所は、多数の魚達の屍の上ということをゆめゆめ忘れるな' },
      { speaker: '主人公', text: '……忘れない。絶対に。' },
    ...
    // 独裁者になる結末を、チヌの呟きで匂わせて終える（ユーザー指定・最後の一行）。
    assistOutro: [
      { speaker: 'サーティー', text: '……終わったな。やれやれ、王様ってのも大したことねえ。' },
      { speaker: 'クエ', text: 'ちょ、待てや。あんた、その目……' },
      { speaker: '主人公', text: '…………。' },
      { speaker: 'サーティー', text: 'おい坊主、どうした。もう終わったんだぞ。……おい？' },
      { speaker: '???', text: '崩れた骨の塊から立ちのぼる黒い瘴気が、主人公の体に纏わりついていく。振り向いた主人公の目には、もう光がなかった。' },
      { speaker: '主人公', text: '……この海は、俺のものだ。' },
      { speaker: 'クエ', text: '……なるほどな。王は死んでも、王座は空かへん。そういう仕組みか。' },
