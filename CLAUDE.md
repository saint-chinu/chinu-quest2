...
- ⚠️ **⑯⑰の未実装スペック（CLAUDE.md内の確定稿）はまだ「ワイ」のまま**
  （「ワイは王になりにきた」「ワイのせいで…めんぼくねぇ…」等）。
  **実装する時に「俺」へ直すこと。**ユーザーが書いた原文をそのまま残して
  あるだけで、口調ルールとしては上書きされている。
...
- 主人公「や、やけにやさぐれた受付だな。えーと、ワイの名前をここに書くだけか。◯◯、っと。」
...
- 主人公「（ワイは…もうダメだ…チヌに逆らわず、田舎で遊んでりゃ良かった）」
