...
### ⚠️ 着手前に確認したいこと
- **主人公とマダイは互いに気づくのか**。②でライバルとして別れた仲なのに、
  上の確定稿では係長として一方的に叱責しており、再会の反応が入っていない。
  「最初は気づかない→後で気づく」のような演出を挟むのか、それとも
  マダイは既に主人公だと分かったうえで(名前を呼んでいる)厳しく当たって
  いるのか（台詞では「おい、（主人公）」と名指ししているので後者に読める）。
- 盤面の有無。この冒頭会話の後に対戦があるのか、会話だけのイベント回なのか。
- 川田の再登場（⑮のメモに「地下労働施設での再会・脱獄協力などが自然」と
  書いてある）をここで回収するのか。
