...
- Service Worker (`public/sw.js`) の `CACHE_NAME` を**毎デプロイbumpする**
  （現在 `chinuquest2-v317`）。bumpしないと古いJS/CSSがキャッシュから配信される。
...
- **クエ40枚（16/6/18）**:
  - 甲鉄要塞4、鉄男4、サンダーバード4、フリーランサー2、テンホウ2。
  - ナンカのお守り4、ライフジャケット2。
  - アイキャンフライ4、帰巣本能4、副業収入4、資本主義の権化4、放電1、ホライズン1。
...
- **比較条件**: 基準はコミット`3416636`。主人公役は`@tools/decks/hinanjo-deck2.json`をCPU操作。
...
- 回帰: lint、カード166件、PvP5件、Cloud23件、準備/救援11件、`cf:dry-run`成功。
  ...
  2ブラウザ実機対戦・演出の目視検証は今回の範囲外。キャッシュv317。
